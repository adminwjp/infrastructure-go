...
func (data1 *DbDataGorm)GetTranction()datas.ITranManager{
	return data1.TranManager
}
func (data1 *DbDataGorm) GetConfig()*datas.DataConfig{
	return data1.Config
}
func (data1 *DbDataGorm)	Insert(obj interface{})(int,error){
...
func (data1 *DbDataGorm)	Update(obj interface{})(int,error){
...
func (data1 *DbDataGorm)	Delete(obj interface{})(int,error){
...
func (data1 *DbDataGorm)	DeleteById(id interface{},entity datas.IDataEntity)(int,error){
...
func (data1 *DbDataGorm)	DeleteByIds(ids []interface{},entity datas.IDataEntity)(int,error){
...
func (data1 *DbDataGorm)	Get(id interface{},entity datas.IDataEntity)(interface{},error){
...
func (data1 *DbDataGorm)	Count(id interface{},entity datas.IDataEntity)(int,error){
	var count int64
...
func (data1 *DbDataGorm)	List(all interface{},entity datas.IDataEntity)(interface{},error){
...
func (data1 *DbDataGorm)	ListByPage(all interface{},entity datas.IDataEntity,page int,size int)(interface{},int64,error){
	var count int64
